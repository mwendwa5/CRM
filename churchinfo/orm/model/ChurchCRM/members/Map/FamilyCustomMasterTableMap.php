...
use ChurchCRM\members\FamilyCustomMaster;
use ChurchCRM\members\FamilyCustomMasterQuery;
...
class FamilyCustomMasterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.members.Map.FamilyCustomMasterTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\members\\FamilyCustomMaster';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.members.FamilyCustomMaster';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\members\\FamilyCustomMaster');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\members\FamilyCustomMaster) { // it's a model object
