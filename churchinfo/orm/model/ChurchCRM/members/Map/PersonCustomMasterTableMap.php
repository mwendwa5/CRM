...
use ChurchCRM\members\PersonCustomMaster;
use ChurchCRM\members\PersonCustomMasterQuery;
...
class PersonCustomMasterTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.members.Map.PersonCustomMasterTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\members\\PersonCustomMaster';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.members.PersonCustomMaster';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\members\\PersonCustomMaster');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\members\PersonCustomMaster) { // it's a model object
