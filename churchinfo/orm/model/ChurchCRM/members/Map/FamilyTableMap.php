...
use ChurchCRM\members\Family;
use ChurchCRM\members\FamilyQuery;
...
class FamilyTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.members.Map.FamilyTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\members\\Family';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.members.Family';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\members\\Family');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\members\Family) { // it's a model object
