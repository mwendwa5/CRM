...
use ChurchCRM\members\Person;
use ChurchCRM\members\PersonQuery;
...
class PersonTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.members.Map.PersonTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\members\\Person';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.members.Person';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\members\\Person');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\members\Person) { // it's a model object
