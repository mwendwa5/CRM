...
use ChurchCRM\members\FamilyCustom;
use ChurchCRM\members\FamilyCustomQuery;
...
class FamilyCustomTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'ChurchCRM.members.Map.FamilyCustomTableMap';
     ...
     */
    const OM_CLASS = '\\ChurchCRM\\members\\FamilyCustom';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'ChurchCRM.members.FamilyCustom';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\ChurchCRM\\members\\FamilyCustom');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \ChurchCRM\members\FamilyCustom) { // it's a model object
