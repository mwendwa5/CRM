...
use \Exception;
use \PDO;
use ChurchCRM\members\PersonCustom as ChildPersonCustom;
...
abstract class PersonCustomQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ChurchCRM\members\Base\PersonCustomQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'churchcrm', $modelName = '\\ChurchCRM\\members\\PersonCustom', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = PersonCustomTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
