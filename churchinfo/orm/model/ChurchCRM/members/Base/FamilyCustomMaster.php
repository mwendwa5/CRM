...
use \Exception;
use \PDO;
use ChurchCRM\members\FamilyCustomMasterQuery as ChildFamilyCustomMasterQuery;
use ChurchCRM\members\Map\FamilyCustomMasterTableMap;
 ...
 *
 *
* @package    propel.generator.ChurchCRM.members.Base
*/
abstract class FamilyCustomMaster implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\members\\Map\\FamilyCustomMasterTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\members\Base\FamilyCustomMaster object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ChurchCRM\members\FamilyCustomMaster The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\members\\FamilyCustomMaster'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ChurchCRM\members\FamilyCustomMaster
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\members\FamilyCustomMaster The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\members\FamilyCustomMaster (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\members\FamilyCustomMaster Clone of current object.
     * @throws PropelException
     */
