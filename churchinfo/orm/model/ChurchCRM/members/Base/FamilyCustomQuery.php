...
use \Exception;
use \PDO;
use ChurchCRM\members\FamilyCustom as ChildFamilyCustom;
...
abstract class FamilyCustomQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ChurchCRM\members\Base\FamilyCustomQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'churchcrm', $modelName = '\\ChurchCRM\\members\\FamilyCustom', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = FamilyCustomTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
