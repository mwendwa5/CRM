...
use \Exception;
use ChurchCRM\members\PersonCustomMaster as ChildPersonCustomMaster;
...
abstract class PersonCustomMasterQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \ChurchCRM\members\Base\PersonCustomMasterQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'churchcrm', $modelName = '\\ChurchCRM\\members\\PersonCustomMaster', $modelAlias = null)
    {
     ...
     * $query->filterByCustomField('%fooValue%'); // WHERE custom_Field LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCustomName('%fooValue%'); // WHERE custom_Name LIKE '%fooValue%'
     * </code>
     *
     ...
     * $query->filterByCustomSide('%fooValue%'); // WHERE custom_Side LIKE '%fooValue%'
     * </code>
     *
