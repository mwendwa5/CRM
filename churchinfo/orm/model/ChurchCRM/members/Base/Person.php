...
use \Exception;
use \PDO;
use ChurchCRM\members\PersonQuery as ChildPersonQuery;
use ChurchCRM\members\Map\PersonTableMap;
...
abstract class Person implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\ChurchCRM\\members\\Map\\PersonTableMap';
    ...
    /**
     * Initializes internal state of ChurchCRM\members\Base\Person object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\ChurchCRM\members\Person The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\ChurchCRM\\members\\Person'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\ChurchCRM\members\Person
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\ChurchCRM\members\Person The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ChurchCRM\members\Person (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ChurchCRM\members\Person Clone of current object.
     * @throws PropelException
     */
